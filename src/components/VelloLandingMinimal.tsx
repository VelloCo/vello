...
export function VelloLandingMinimal() {
  return <div className="min-h-screen overflow-hidden bg-paper pb-20 text-ink sm:pb-0">
    ...
    <Footer />
    <a href={signup} className="vello-action fixed inset-x-4 bottom-4 z-30 flex h-12 items-center justify-center rounded-[10px] bg-ink font-body text-[14px] font-semibold text-paper shadow-[0_18px_44px_rgba(18,40,58,.26)] sm:hidden">Criar meu catálogo <ArrowRight className="vello-action-arrow ml-2" size={16} /></a>
  </div>;
}
