...
function CatalogCustomizationPage({ user, profile, properties, toast }: { user: User; profile: Profile; properties: Property[]; toast: (value: string) => void }) {
  ...
  return <>
    ...
    <div className="mt-6 rounded-2xl border border-line bg-[#f5f2ec] px-5 py-4 font-body text-sm text-ash"><span className="font-semibold text-ink">Como funciona:</span> estilo define o formato dos cards; cor define o fundo e a identidade visual.</div>
