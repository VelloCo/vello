  ...
  return (
    <>
      ...
      <main className="overflow-hidden bg-[#f5f2ec] pb-28">
        ...
        {contact && <section className="px-5 pb-14 sm:px-8 sm:pb-20"><div className="mx-auto max-w-[980px] rounded-[28px] bg-ink px-6 py-16 text-center text-paper sm:rounded-[34px] sm:px-10 sm:py-20"><h2 className="mx-auto max-w-[650px] font-display text-[39px] font-semibold leading-[.92] tracking-[-.055em] sm:text-6xl">Gostou de algum imóvel?</h2><a href={contact} target="_blank" rel="noreferrer" className="mx-auto mt-9 inline-flex h-14 items-center justify-center gap-3 rounded-full bg-paper px-7 font-body text-sm font-semibold text-ink transition hover:scale-[1.02] hover:bg-white"><MessageCircle size={18} />Falar com {catalog.profile.professional_name.split(" ")[0]} <ArrowUpRight size={16} /></a><p className="mt-6 font-mono text-[10px] tracking-[.08em] text-paper/45 sm:text-[11px]">Tire suas dúvidas ou marque uma visita pelo WhatsApp.</p></div></section>}
      </main>
      {contact && (
        <a
          href={contact}
