        ...
        <Reveal delay={0.12} className="mt-12 w-full max-w-[520px]">
          <article className="relative overflow-hidden rounded-[26px] bg-ink p-7 text-paper shadow-[0_35px_90px_-35px_rgba(11,11,10,0.65)] md:p-9">
            ...
            <div className="relative">
              ...
              <a href="/cadastro" className="group mt-8 flex items-center justify-center gap-2 rounded-full bg-paper py-4 font-body text-[14px] font-semibold text-ink transition-transform hover:scale-[1.02]">Criar meu catálogo <ArrowRight size={16} className="transition-transform group-hover:translate-x-0.5" /></a>
