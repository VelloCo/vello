  ...
  render() {
    ...
    return <main className="grid min-h-screen place-items-center bg-paper p-6 text-ink">
      <section className="w-full max-w-lg rounded-2xl border border-line bg-white p-8">
        ...
        <button type="button" onClick={() => window.location.reload()} className="vello-primary bg-sky text-ink mt-6 min-h-12 w-full rounded-full px-4">Tentar novamente</button>
