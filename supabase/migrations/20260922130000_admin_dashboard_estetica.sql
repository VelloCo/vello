-- Painel administrativo com métricas de estética (substitui imóveis/seleções).
-- Não expõe dados de clientes finais: agendamentos mostram só serviço,
-- profissional, status e data.
